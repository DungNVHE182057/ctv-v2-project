...
const basicTextDescriptionCss = `p, span{
...
export const cssData = [
  ...
  },
  {
    ...
    The goal is:</p>
    <img class = 'c' src="${images.itemKnightActive}" /> <span>takes</span>
    <img src="${images.itemApple}" /> 
    <img class = 'c' src="${images.itemMageActive}" /> <span>takes</span>
    <img src="${images.itemCheese}" /> 
    <img class = 'c' src="${images.itemRogueActive}" /> <span>takes</span>
  ...
  },
  {
    ...
    The goal is:</p>
    <img src="${images.itemKnightActive}" /> <span>vs</span>
    <img src="${images.itemZZZ}" /> 
    <img src="${images.itemMageActive}" /> <span>vs</span>
    <img src="${images.itemSnake}" />
    <img src="${images.itemRogueActive}" /> <span>vs</span>
